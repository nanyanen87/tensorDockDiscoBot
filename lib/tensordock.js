...
class TensorDock {
    ...
    async bidPrice (serverId, price){
        ...
        const param = {server: serverId, price: price};
        const res = await this.sendRequest(endpoint, param);
        if (res.success === false){
            return res.error;
        }
    ...
    // --data-urlencode 'serverId=cb3c501e-b85c-473d-9ab1-04dbb3e28450' \
    ...
    async list (){
        ...
        // {serverId1: {id: serverId1, name: server_name1}, serverId2: {id: serverId2, name: server_name2}}
